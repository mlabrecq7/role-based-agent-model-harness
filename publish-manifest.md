...
| `automated-test-creator` | public |
| `architectagent` | public |
| `tddimplementer` | public |
| `interactive-test-creator` | public |
| `production-deployment` | **private** — never export |
| `boundary-analyst` | public |
